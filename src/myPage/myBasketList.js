          ...
          {myBasketItemList.map((basketItem) => {
            return (
              <Col span={4.5} className="col">
                <Card hoverable key={basketItem.itemId} className="cards">
                  <HeartFilled
                    onClick={() => {
                      delBasket(basketItem.itemId);
                    }}
                  ></HeartFilled>
                  ...
                  <span>
                    <h2
                      className="title"
                      onClick={() => {
                        toProductViewDetailsPage(basketItem.itemId);
                      }}
                    >
                      제목: {basketItem.itemTitle}
                    </h2>
