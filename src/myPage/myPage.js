...
function MyPage() {
  ...
  const [isSelect0, setIsSelect0] = useState(true);
  ...
  const onProfileChange = () => {
    ...
    imageAntList.forEach((image) =>
      formData.append("clientPhoto", image.originFileObj)
    );
  ...
  const TapContent = [
    {
      myTitle: (
        <li
          className={isSelect0 ? "tabTitle1_Active" : "tabTitle1"}
          onClick={() => {
            tabHandler(0);
            setIsSelect0(true);
            setIsSelect1(false);
    ...
    },
    {
      myTitle: (
        <li
          className={isSelect1 ? "tabTitle_Active" : "tabTitle"}
          onClick={() => {
            tabHandler(1);
            setIsSelect0(false);
            setIsSelect1(true);
    ...
    },
    {
      myTitle: (
        <li
          className={isSelect2 ? "tabTitle_Active" : "tabTitle"}
          onClick={() => {
            tabHandler(2);
            setIsSelect0(false);
            setIsSelect1(false);
    ...
    },
    {
      myTitle: (
        <li
          className={isSelect3 ? "tabTitle_Active" : "tabTitle"}
          onClick={() => {
            tabHandler(3);
            setIsSelect0(false);
            setIsSelect1(false);
